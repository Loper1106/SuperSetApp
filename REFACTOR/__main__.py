...
class Gui:
    def __init__(self):
        ...
        button_save = Button(self.window, text="Save", width=10, command=lambda: data.saveProgress(self.window, Workout.completeWorkouts))
        ...
        button_progress = Button(self.window, text="Progress", width=10, command=lambda: data.progress(intro))
